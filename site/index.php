...
<head>
    ...
    <title>START | Pausar não é uma OPÇÃO!</title>
...
<div class="player">
    ...
    <div class="player-video">
        <button class="btn-theme position-absolute rounded-circle p-0" aria-label="Temas"><i class="bi bi-moon-stars-fill"></i></button>
...
<script defer src="<?php $_SERVER['HTTP_HOST'];?>/canal_start/site/assets/js/main.min.js"></script>
</body>
</html>